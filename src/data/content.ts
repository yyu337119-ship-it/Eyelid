...
export const categories: Category[] = [
            ...
            "assays": [
              {
                ...
                "observations": [
                  "YFP标记的K6⁺过度角化细胞",
                  "给予TAM 10days:\n大体观察：Cre Abca12→cKO小鼠眼睑干燥和结痂 \n免疫荧光： MG导管被YFP标记的K6⁺过度角化细胞填充。\nH&E：MG导管阻塞和扩张\nOil Red O：脂质潴留\n",
                  "给予TAM 14days： K6⁺过度角化细胞脱落\n"
                ],
                "figures": [
                  {
                    "src": "/figures/paper1-fig-phenotype.jpg",
                    "paperFig": "Fig. B / D / E",
                    "caption": "B：对照 vs cKO 眼睑结痂。D：HE 导管阻塞扩张。E：Oil Red O，cKO 导管内脂质潴留。A/C/F 的 IF 见分子标志物。",
                    "id": "mg-abca12-duct-fig-0"
                  }
                ]
              },
              {
                ...
                "figures": [
                  {
                    ...
                    "caption": "A：绿=Ly6G，红=K14，标注 Epi / MD / Ac / Conj。计数分 Contacting gland 与 boxed area。cKO 不高于对照。",
                    "id": "mg-ly6g-exclude-fig-0"
                  }
                ]
              },
              {
                ...
                "figures": [
                  {
                    ...
                    "paperFig": "Fig. 7A",
                    "caption": "上排 Awat2−/−/DMSO，下排 Awat2−/−/ATR101。左列纵切大体，右列 HE。红线标中央导管，绿箭头标开口堵塞。原图亦含 7B 核数与 7C RT-qPCR。",
                    "id": "mg-gross-he-fig-0"
                  }
                ]
              },
              {
                ...
                "figures": [
                  {
                    "src": "/figures/paper2-fig7-mg.jpg",
                    "paperFig": "Fig. 7B",
                    "caption": "Average meibocyte nuclei count。Awat2−/−/DMSO < ATR101 < WT。",
                    "id": "mg-nuclei-count-fig-0"
                  }
                ]
              },
              {
                ...
                "figures": [
                  {
                    ...
                    "paperFig": "Fig. 2A–D",
                    "caption": "P11。A：对照眼睑仍闭合；B：KR/TG 过早睁眼，上下睑肿胀，下睑更明显。C/D：HE 确认开睑与肿胀。",
                    "id": "mg-stereo-close-fig-0"
                  },
                  {
                    "src": "/figures/paper5-fig3-mg.jpg",
                    "paperFig": "Fig. 3A–C",
                    "caption": "P15 结膜面大体。对照 MG 平行排列完整；重症腺体部分缺失、畸形；轻症大体接近对照。",
                    "id": "mg-stereo-close-fig-1"
                  }
                ]
              },
              {
                ...
                "figures": [
                  {
                    "src": "/figures/paper5-fig3-mg.jpg",
                    "paperFig": "Fig. 3D–I",
                    "caption": "HE：对照腺泡成簇、开口在 MCJ 前方；重症导管扩张、开口异位到皮肤侧、间充质堆积；轻症大体接近对照但间充质仍增多。",
                    "id": "mg-he-acini-fig-0"
                  }
                ]
              },
              {
                ...
                "figures": [
                  {
                    ...
                    "paperFig": "Fig. 6A–C",
                    "caption": "A：不同 Z 深度切片，黑箭头标导管。B：三维渲染，红=导管、绿=腺泡。C：中央导管最大直径箱线图。",
                    "id": "mg-3d-duct-fig-0"
                  }
                ]
              },
                ...
                "figures": [
                  {
                    ...
                    "paperFig": "Fig. 5B",
                    "caption": "B：MG terminal duct thickness (Dx−Do)/Do。ATR101 组在 Day 10、Day 14 均低于溶剂对照。A 为同一批裂隙灯导管图像。",
                    "id": "mg-terminal-duct-fig-0"
                  }
                ]
              }
            ]
                ...
                "figures": [
                  {
                    "src": "/figures/paper1-fig-phenotype.jpg",
                    "paperFig": "Fig. A / C / F",
                    "caption": "A：绿=YFP，红=K14，正常解剖。C：cKO 导管被 YFP⁺ 角化细胞填充。F：14 天角化细胞脱落。大体/HE/ORO 见 ①。",
                    "id": "mg-abca12-markers-fig-0"
                  }
                ]
              },
              {
                ...
                "markers": [
                  {
                    "name": "KROX20 / GFP",
                    "role": "当前表达的 MG 干/祖细胞",
                    "change": "P3–P6 在腺泡形成前的上皮索；P11 后集中于导管上基底层，持续至成年。与 PPARγ⁺ 腺泡细胞基本不共定位"
                  },
                  {
                ...
                "figures": [
                  {
                    ...
                    "paperFig": "Fig. 3",
                    "caption": "A：P3 至 9 月龄 KROX20（绿）与 K14（红）。成熟后 KROX20 在导管上基底层。B：KROX20 与 PPARγ 分区，几乎不重叠。",
                    "id": "mg-krox20-lineage-fig-0"
                  },
                  {
                    "src": "/figures/paper3-fig4-lineage.jpg",
                    "paperFig": "Fig. 4",
                    "caption": "A：P1–10 月龄 tdTomato 铺满腺体。B：与 K14 重叠。C：与 PPARγ 重叠，谱系可生成腺泡细胞。",
                    "id": "mg-krox20-lineage-fig-1"
                  },
                  {
                    "src": "/figures/paper3-fig2-mg.jpg",
                    "paperFig": "Fig. 2A–D",
                    "caption": "Krox20-Cre;R26-tdTomato。角膜和 K15⁺ 角膜缘无 Tom 信号（白/绿箭头），用于把角膜病变判为继发。",
                    "id": "mg-krox20-lineage-fig-2"
                  }
                ]
              },
              {
                ...
                "figures": [
                  {
                    "src": "/figures/paper3-fig2-mg.jpg",
                    "paperFig": "Fig. 2E–J",
                    "caption": "E：H&E，cKO 睑板腺缺失。F：K14/PPARγ 腺体标志消失。H–J：KROX20 与 K14 共染确认靶蛋白丢失。A–D 为角膜缘谱系，见角膜分支。",
                    "id": "mg-krox20-absent-fig-0"
                  },
                  {
                    "src": "/figures/paper3-fig5-dta.jpg",
                    "paperFig": "Fig. 5",
                    "caption": "P6 清除 KROX20⁺ 上皮谱系。A：KROX20 消失。B：H&E 无腺体。C：K14/PPARγ 缺失。D：Oil Red O 无睑脂。",
                    "id": "mg-krox20-absent-fig-1"
                  },
                  {
                    "src": "/figures/paper3-fig6-adult.jpg",
                    "paperFig": "Fig. 6C–E",
                    "caption": "成年期诱导清除。C：H&E 已形成腺体丢失。D：K14/PPARγ 缺失。E：KROX20 信号消失。A–B 为继发角膜病变。",
                    "id": "mg-krox20-absent-fig-2"
                  },
                  {
                    "src": "/figures/paper3-fig8-mg.jpg",
                    "paperFig": "Fig. 8B–F",
                    "caption": "WT / Krox24-KO 保留腺体；Krox20-cKO 与双敲腺体缺失。E–F：Krox24-KO 仍表达 KROX20。",
                    "id": "mg-krox20-absent-fig-3"
                  }
                ]
              },
              {
                ...
                "figures": [
                  {
                    ...
                    "paperFig": "Fig. 1",
                    "caption": "a：UMAP 细胞分群。b：导管–腺泡结构示意图。c–d：RNA velocity 与拟时序，导管基底和腺泡基底走向分化睑脂细胞。",
                    "id": "mg-zhu-stem-fig-0"
                  },
                  {
                    "src": "/figures/paper4-fig2-lineage.jpg",
                    "paperFig": "Fig. 2",
                    "caption": "a：P50 诱导、2 天 vs 90/120 天。b–d：Lrig1/Lgr6/Axin2 从导管扩展。e：Gli2。f：Slc1a3 偏腺泡。绿/品红=谱系，红=PLIN2。",
                    "id": "mg-zhu-stem-fig-1"
                  }
                ]
              },
              {
                ...
                "figures": [
                  {
                    ...
                    "paperFig": "Fig. 3",
                    "caption": "a–c：整腺形态，CD=中央导管，黄星=脱落腺泡。d–k：PPARγ、FASN、Ki-67。l–m：腺泡与导管基底 Ki-67⁺ 比例下降。",
                    "id": "mg-zhu-morphology-fig-0"
                  },
                  {
                    "src": "/figures/paper4-fig4-gli2.jpg",
                    "paperFig": "Fig. 4",
                    "caption": "激活 Hh / GLI2 后腺体增大、基底细胞扩增，与 Smo 敲除方向相反，构成双向遗传学证据。",
                    "id": "mg-zhu-morphology-fig-1"
                  }
                ]
              },
              {
                ...
                "figures": [
                  {
                    "src": "/figures/paper2-fig7-mg.jpg",
                    "paperFig": "Fig. 7C",
                    "caption": "睑板组织 RT-qPCR：Aldh1a3、Rarb、Rbp1、Sprr1a、Pparg、Krt14（相对 Gapdh）。ATR101 后角化/修复轴下降，Pparg 回升。",
                    "id": "mg-rtqpcr-fig-0"
                  }
                ]
              },
                ...
                "figures": [
                  {
                    ...
                    "paperFig": "Fig. 2D",
                    "caption": "黄圈标挤出的睑脂。左：Awat2−/−/DMSO 蜡样不透明；右：ATR101 后更透明、体积更小。同图 B/C/E 为 CE、FA 与熔融温度。",
                    "id": "meibum-appearance-fig-0"
                  }
                ]
              },
              {
                ...
                "figures": [
                  {
                    "src": "/figures/paper2-fig5-mg-duct.jpg",
                    "paperFig": "Fig. 5A",
                    "caption": "裂隙灯观察上睑末端导管。Day 0 先挤出堵塞物，随后随访 Day 10 / 14。ATR101 组导管更清晰、阻塞减轻。",
                    "id": "meibum-expressibility-fig-0"
                  }
                ]
              }
            ]
            ...
            "assays": [
              {
                ...
                "markers": [
                  {
                    "name": "CE（胆固醇酯）",
                    "role": "SOAT1 产物，过高则睑脂变黏、熔点升高",
                    "change": "ATR101 后 CE 显著下降"
                  },
                  {
                    "name": "饱和 FA ↓ / 单不饱和 FA ↑",
                    "role": "流动性相关脂酰组成",
                    "change": "治疗后饱和 FA 下降、单不饱和 FA 升高"
                  }
                ],
                "observations": [
                ...
                "figures": [
                  {
                    ...
                    "caption": "B：CE 含量。C：饱和与单不饱和 FA。E：熔融温度重复测量。A 为给药方案，D 为大体外观。",
                    "id": "meibum-biophysics-fig-0"
                  }
                ]
              }
            ]
  ...
  },
  {
    ...
    "summary": "角膜先用大体和荧光素看破损与混浊，再用 HE 看上皮增厚、炎症和新生血管，最后用 K12 / K14 / K15 / K1 / loricrin 判断是否鳞状化生。泪膜用镜面光反射和 TBUT；泪液量、泪河仍待补。读片时先排除角膜本身是否表达致病基因，再判断是否继发于睑板腺缺失。",
    "sections": [
      {
        "id": "cornea",
        "index": "1",
                ...
                "figures": [
                  {
                    ...
                    "paperFig": "Fig. 1A–E",
                    "caption": "A–B：活体和离体角膜混浊。C–D：HE 全层。E：1–12 月龄进展。F–I 标志物见下一分支。",
                    "id": "cornea-krox20-gross-fig-0"
                  },
                  {
                    "src": "/figures/paper3-fig1-he-zoom.jpg",
                    "paperFig": "Fig. 1D 放大",
                    "caption": "上：cKO 上皮增厚、过度角化，基质炎症和新生血管。下：对照薄而规则的角膜上皮。",
                    "id": "cornea-krox20-gross-fig-1"
                  },
                  {
                    "src": "/figures/paper3-fig7-krox24.jpg",
                    "paperFig": "Fig. 7A–C",
                    "caption": "WT 与 Krox24-KO 眼表正常；Krox20-cKO 和双敲出现炎症、过度角化和鳞状化生。",
                    "id": "cornea-krox20-gross-fig-2"
                  }
                ]
              },
              {
                ...
                "figures": [
                  {
                    ...
                    "paperFig": "Fig. 3C–D",
                    "caption": "C：钴蓝光下荧光素着染，Day 0 / 10 / 14。D：着染积分密度，ATR101 组显著低于 DMSO。",
                    "id": "cornea-fluorescein-fig-0"
                  }
                ]
              },
              {
                ...
                "figures": [
                  {
                    ...
                    "paperFig": "Fig. 4A",
                    "caption": "列：表层 / 翼状 / 基底上皮。行：WT、Awat2−/−/DMSO、Awat2−/−/ATR101。黄箭头脱落/鳞状化生，红箭头固缩核。",
                    "id": "cornea-confocal-fig-0"
                  }
                ]
              }
            ]
                ...
                "figures": [
                  {
                    "src": "/figures/paper3-fig1-cornea.jpg",
                    "paperFig": "Fig. 1F–I",
                    "caption": "F：K14/K12，cKO 丢失 K12。G：K15。H：K1。I：loricrin。下排对照。",
                    "id": "cornea-krox20-markers-fig-0"
                  },
                  {
                    "src": "/figures/paper3-fig7-krox24.jpg",
                    "paperFig": "Fig. 7D–G",
                    "caption": "K12⁺ 角膜上皮被 K14、K15、K1 和 loricrin⁺ 角化表皮样上皮取代。",
                    "id": "cornea-krox20-markers-fig-1"
                  }
                ]
              },
              {
                ...
                "markers": [
                  {
                    "name": "Krt14（红色）",
                    "role": "基底上皮祖细胞，具备增殖能力",
                    "change": "应激后上调，并错误定位到浅表层；ATR101 后浅表异位减轻，mRNA 回落至接近 WT"
                  },
                  {
                    "name": "Krt12（绿色）",
                    "role": "终末分化的基底上层及浅表上皮",
                ...
                "figures": [
                  {
                    "src": "/figures/paper2-fig4-cornea.jpg",
                    "paperFig": "Fig. 4B–C",
                    "caption": "B：红=Krt14，绿=Krt12。DMSO 组浅表 Krt14 异位。C：Krt14、Sprr1a 相对 Gapdh 的 RT-qPCR。",
                    "id": "cornea-markers-fig-0"
                  }
                ]
              }
            ]
                ...
                "figures": [
                  {
                    "src": "/figures/paper2-fig3-tear-cornea.jpg",
                    "paperFig": "Fig. 3A",
                    "caption": "镜面光反射。DMSO 组环形反光碎裂、扭曲；ATR101 组恢复较完整圆环。标尺 200 μm。",
                    "id": "tear-specular-fig-0"
                  }
                ]
              }
            ]
                ...
                "figures": [
                  {
                    "src": "/figures/paper2-fig3-tear-cornea.jpg",
                    "paperFig": "Fig. 3B",
                    "caption": "Tear film break-up time。Awat2−/−/DMSO < ATR101 < WT。",
                    "id": "tear-tbut-fig-0"
                  }
                ]
              }
  ...
  },
  {
    ...
    "summary": "结膜评价分三层：HE 看睑缘/结膜上皮厚度，PAS 看穹窿杯状细胞，免疫荧光用 Krt4（黏膜）和 Krt10（表皮）判断 MCJ 是否被表皮化。",
    "sections": [
      {
        "id": "conj-structure",
        "index": "1",
                ...
                "figures": [
                  {
                    ...
                    "paperFig": "Fig. 5A–D",
                    "caption": "HE：对照 A、C vs 转基因 B、D。结膜上皮与皮肤黏膜移行上皮增厚。",
                    "id": "conj-he-fig-0"
                  }
                ]
              }
  ...
  },
  {
    ...
    "roman": "四",
    "title": "眼睑相关肌肉",
    "question": "睑板肌和眼轮匝肌是否存在？肌腱/睑板是否由神经嵴细胞过度增生而畸形？",
    "summary": "先用 α-SMA 和骨骼肌肌球蛋白确认 TM、OO 本身大体正常，再用 Wnt1Cre 谱系追踪和马松三色看 CPF/TP 是否细胞堆积、胶原丢失。增殖（PCNA）、凋亡（TUNEL）和 EGFR / β-catenin / N-cadherin 解释肌腱细胞为何停在祖细胞状态。",
    "sections": [
      {
        "id": "muscle-identity",
        "index": "1",
                ...
                "figures": [
                  {
                    ...
                    "paperFig": "补充图 1A、1B",
                    "caption": "P15。红=α-SMA（TM），绿=骨骼肌肌球蛋白（OO），蓝=DAPI。KR 与 KR/TG 总体相似；远端可因囊肿局部中断。",
                    "id": "muscle-sma-myosin-fig-0"
                  }
                ]
              }
            ]
                ...
                "figures": [
                  {
                    ...
                    "caption": "下睑。绿=神经嵴来源。对照 CPF/TP 为绿色；KR/TG 后 CPF、TP 明显增厚，TM 相对不受累。",
                    "id": "muscle-lineage-trace-fig-0"
                  },
                  {
                    "src": "/figures/paper5-suppl-fig2-upper-lid.jpg",
                    "paperFig": "补充 Fig. 2",
                    "caption": "上睑 P15。神经嵴来源细胞（绿）在上睑肌腱贡献少，可解释下睑表型更重。",
                    "id": "muscle-lineage-trace-fig-1"
                  }
                ]
              }
            ]
                ...
                "figures": [
                  {
                    ...
                    "paperFig": "Fig. 4",
                    "caption": "P0–P15 诱导后 P15 取材。对照胶原丰富、细胞稀少；转基因细胞增多、胶原下降，睑板区可见囊肿。",
                    "id": "muscle-masson-adult-fig-0"
                  }
                ]
              },
              {
                ...
                "figures": [
                  {
                    ...
                    "paperFig": "Fig. 7A–G",
                    "caption": "对照 A/B/D/F，转基因 C/E/G。P0–P11 马松三色。同一时间点左右对照，避免把发育阶段差异当成表型。",
                    "id": "muscle-masson-time-fig-0"
                  }
                ]
              }
            ]
